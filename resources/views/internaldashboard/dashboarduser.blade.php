                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="my-3">
                                                ...
                                                @foreach ($revenues as $item)
                                                    @php
                                                        ...
                                                        $persentase = number_format($persentase); // Menggunakan fungsi number_format() dengan 2 desimal
                                                    @endphp
                                                @break
                                                @endforeach
                                            ...
                                            <div class="my-3">
                                                ...
                                                <span class="">Persentasi : {{ $item->persentase }}%</span>
                                                <div class="container">
                                                    <div class="row mt-3 text-center">
                                                        <div class="col-12">
                                                            <div class="progress">
                                                                <div class="progress-bar bg-{{ $item->persentase > 60 ? $item->persentase > 80 ? 'success' : 'warning' : 'danger' }}" role="progressbar" style="width: {{ $item->persentase }}%" aria-valuenow="{{ $item->persentase }}" aria-valuemin="0" aria-valuemax="100">
                                ...
                                <div class="col-md mg-md-t-0">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            {{-- end revenue VI februari --}}
                                            {{-- Net Profit VI februari --}}
                                            <div class="my-3">
                                                <h6 class="card-text bd-t">Net Profit</h6>
                                                <span class="card-text">Tercapai : 8%</span><br>
                                                <div class="container">
                                        ...
                                        <tr>
                                            ...
                                            @foreach ($revenues as $item)
                                                @php
                                                    ...
                                                    $nilai2 =   24000000000; //target pertahun
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-end">
                                                    ...
                                                    <div class="">
                                                        <a class="btn btn-info btn-sm" href="/dashboardVI/grafik">Grafik</a>   
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
